    ...
    >
      ...
      <div className="space-y-2.5 mb-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-2xl bg-[#FEE500] hover:bg-[#FFDC00] transition-colors duration-150 text-sm font-medium text-[#3C1E1E] shadow-sm"
        >
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-[#f7fdf9] dark:bg-sage-950 px-3 text-sage-400 font-medium">또는 아이디로</span>
        </div>
      </div>
